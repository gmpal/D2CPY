...
def compute_descriptors(ts_builder = None, data_path = None, n_jobs=1, output_folder= 'new_data/', mutual_information_proxy='Ridge', proxy_params=None):
    """
    ...
    """
    descr_gen = DescriptorsGenerator(ts_builder=ts_builder, data_path = data_path, n_jobs=n_jobs, mutual_information_proxy=mutual_information_proxy, proxy_params=proxy_params)
    descr_gen.generate()
...
if __name__ == "__main__":
    ...
    n_gen_proc = 17
    n_series_per_generative_process = 5
    n_jobs = 2
    output_folder = f'2024.01.17/'
